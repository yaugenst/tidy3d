...
class RectangularDielectric(Tidy3dBaseModel):
    ...
    def _check_non_metallic(val, info):
        ...
        freqs = C_0 / info.data["wavelength"]
    ...
    def _set_box_medium(self):
        ...
        if self.box_medium is None:
            ...
            if isinstance(self.clad_medium, tuple):
                clad_medium = self.clad_medium[0]
                object.__setattr__(self, "box_medium", clad_medium)
        return self
    ...
    def _set_clad_thickness(self):
        ...
        for side in ("clad", "box"):
            ...
            if val is None:
                ...
                object.__setattr__(self, side + "_thickness", self._set_non_negative_array(val))
        return self
    ...
    def _set_side_margin(self):
        ...
        if self.side_margin is None:
            ...
            self.side_margin = max(clad_thickness, box_thickness)
        return self
