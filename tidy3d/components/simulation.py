    ...
    **Lectures:**
    ...
    def _check_3d_simulation_with_lumped_elements(self):
        ...
        if val and size.count(0.0) > 0:
            raise ValidationError(
                f"'{self.__cls__.__name__}' must be a 3D simulation when a 'LumpedElement' is present."
            )
        return self
...
class Simulation(AbstractYeeGridSimulation):
    ...
    *   `High-Q silicon resonator <../../notebooks/HighQSi.html>`_
    ...
    def to_gdstk(
        ...
        gds_layer_dtype_map: dict[AbstractMedium, tuple[NonNegativeInt, NonNegativeInt]] = None,
    ) -> list:
