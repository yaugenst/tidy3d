...
class Tidy3dBaseModel(BaseModel):
    ...
    def updated_copy(
        ...
        if isinstance(sub_component, (list, tuple)):
            try:
                ...
                raise ValueError(
                    f"Expected integer index into '{field_name}' " f"in path '{path}'."
                )
    ...
    @classmethod
    def from_file(cls: Type[T], fname: str, group_path: str = None, **parse_obj_kwargs) -> T:
    ...
    @classmethod
    def dict_from_file(cls: Type[T], fname: str, group_path: str = None) -> dict:
    ...
    @classmethod
    def from_json(cls: Type[T], fname: str, **parse_obj_kwargs) -> T:
    ...
    @classmethod
    def from_yaml(cls: Type[T], fname: str, **parse_obj_kwargs) -> T:
    ...
    def dict_from_hdf5_gz(
        cls: Type[T], fname: str, group_path: str = "", custom_decoders: list[Callable] = None
    ) -> dict:
    ...
    def insert_traced_fields(self, field_mapping: AutogradFieldMap) -> Self:
