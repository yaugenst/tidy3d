...
class Geometry(Tidy3dBaseModel, ABC):
    ...
    def load_gds_vertices_gdstk(
        gds_cell, gds_layer: int, gds_dtype: int = None, gds_scale: PositiveFloat = 1.0
    ) -> list[ArrayFloat2D]:
